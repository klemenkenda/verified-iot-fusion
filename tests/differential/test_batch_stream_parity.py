...
PROGRAM: dict[str, Any] = {
    ...
    "nodes": [
        ...
        {"id": "dom", "op": "day_of_month", "params": {"timezone": "Europe/Ljubljana"}},
        {"id": "doy", "op": "day_of_year", "params": {"timezone": "Europe/Ljubljana"}},
        {"id": "moy", "op": "month_of_year", "params": {"timezone": "Europe/Ljubljana"}},
        {"id": "wknd", "op": "is_weekend", "params": {"timezone": "Europe/Ljubljana"}},
        {
            "id": "hol",
            "op": "is_holiday",
    ...
    "calendars": {"si": ["2024-01-01", "2024-01-02", "2024-02-08"]},
    "outputs": [
        "hod",
        "dow",
        "dom",
